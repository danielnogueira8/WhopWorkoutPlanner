...
const meta = {
    ...
    component: __1.DatePicker,
    args: {
        size: __1.datePickerPropDefs.size.default,
        color: __1.datePickerPropDefs.color.default,
        minValue: (0, date_1.parseDate)('1901-01-03'),
        defaultValue: (0, date_1.parseDate)('2020-02-03'),
        maxValue: (0, date_1.parseDate)('2022-03-03'),
...
exports.Default = {
    ...
    render: (args) => (react_1.default.createElement("div", { style: { display: 'flex', flexDirection: 'column', gap: 'var(--space-5)' } },
        react_1.default.createElement(__1.DatePicker, { ...args }))),
};
exports.Sizes = {
    args: {},
    render: (args) => (react_1.default.createElement("div", { style: { display: 'flex', flexDirection: 'column', gap: 'var(--space-5)' } },
        react_1.default.createElement(__1.DatePicker, { ...args, size: "1" }),
        react_1.default.createElement(__1.DatePicker, { ...args, size: "2" }),
        react_1.default.createElement(__1.DatePicker, { ...args, size: "3" }),
        react_1.default.createElement(__1.DatePicker, { ...args, size: "4" }))),
};
exports.Custom = {
    args: {},
    render: () => {
        const [date, setDate] = react_1.default.useState((0, date_1.parseDate)('2020-02-03'));
        const [open, setOpen] = react_1.default.useState(true);
        return (react_1.default.createElement("div", { style: { marginTop: -200 } },
            react_1.default.createElement(__1.Popover.Root, { open: open, onOpenChange: setOpen },
                react_1.default.createElement(__1.Popover.Trigger, null,
                    react_1.default.createElement(__1.Button, { size: "3" },
                        ...
                        " ",
                        date.toString())),
                react_1.default.createElement(__1.Popover.Content, { variant: "translucent", align: "center", style: { width: 'unset' } },
                    react_1.default.createElement(__1.Calendar, { minValue: (0, date_1.parseDate)('2020-01-03'), defaultValue: date, maxValue: (0, date_1.parseDate)('2020-03-03'), onChange: (value) => {
                            setDate(value);
                            setOpen(false);
                        } })))));
    },
