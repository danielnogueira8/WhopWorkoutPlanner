...
declare const AvatarGroupRoot: {
    (props: AvatarGroupRootProps): React.JSX.Element;
    displayName: string;
};
type AvatarGroupAvatarProps = Omit<React.ComponentProps<typeof Avatar>, 'size' | 'shape'>;
declare const AvatarGroupAvatar: {
    ({ className, ...props }: AvatarGroupAvatarProps): React.JSX.Element;
    displayName: string;
};
