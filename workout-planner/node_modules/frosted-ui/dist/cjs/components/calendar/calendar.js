...
function YearDropdown({ state }) {
    ...
    return (react_1.default.createElement(__1.Select.Root, { "aria-label": "Year", value: currentYearIndex.toString(), onValueChange: onChange, disabled: state.isDisabled, size: "1" },
