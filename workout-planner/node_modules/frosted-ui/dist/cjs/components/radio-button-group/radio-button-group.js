...
exports.Root = exports.Item = exports.Icon = void 0;
const tslib_1 = require("tslib");
const classnames_1 = tslib_1.__importDefault(require("classnames"));
const radix_ui_1 = require("radix-ui");
const React = tslib_1.__importStar(require("react"));
const radio_button_group_props_1 = require("./radio-button-group.props");
...
const RadioButtonGroupRoot = (props) => {
    const { className, color = radio_button_group_props_1.radioButtonGroupPropDefs.color.default, highContrast = radio_button_group_props_1.radioButtonGroupPropDefs.highContrast.default, children, ...rootProps } = props;
    return (React.createElement(radix_ui_1.RadioGroup.Root, { "data-accent-color": color, ...rootProps, className: (0, classnames_1.default)('fui-RadioButtonGroupRoot', className, { 'fui-high-contrast': highContrast }) },
        React.createElement(RadioButtonGroupContext.Provider, { value: React.useMemo(() => ({ color, highContrast }), [color, highContrast]) }, children)));
};
exports.Root = RadioButtonGroupRoot;
...
const RadioButtonGroupItem = (props) => {
    ...
    return (React.createElement(radix_ui_1.RadioGroup.Item, { style: style, ...itemProps, className: (0, classnames_1.default)('fui-reset', 'fui-RadioButtonGroupButton', 'fui-RadioButtonGroupItem', className), asChild: true }, updatedChildren));
};
exports.Item = RadioButtonGroupItem;
...
const RadioButtonGroupIcon = (props) => {
    ...
    return (React.createElement("div", { "data-accent-color": color, className: (0, classnames_1.default)('fui-RadioButtonGroupIcon', { 'fui-high-contrast': highContrast }, className), "aria-hidden": true, ...itemProps },
...
exports.Icon = RadioButtonGroupIcon;
RadioButtonGroupIcon.displayName = 'RadioButtonGroupIcon';
const addOverlayToChildren = (children) => {
    if (React.Children.count(children) === 1) {
        const child = React.Children.only(children);
        return React.cloneElement(child, {}, React.Children.toArray(child.props.children).concat(React.createElement(RadioButtonGroupOverlay, { key: "radio-button-group-overlay" })));
    }
    return children;
};
