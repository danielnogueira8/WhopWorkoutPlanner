...
const Avatar = (props) => {
    const { className, style, size = avatar_props_1.avatarPropDefs.size.default, color = avatar_props_1.avatarPropDefs.color.default, highContrast = avatar_props_1.avatarPropDefs.highContrast.default, fallback: fallbackProp, shape = avatar_props_1.avatarPropDefs.shape.default, ...imageProps } = props;
    ...
    return (React.createElement(AvatarPrimitive.Root, { "data-accent-color": color, "data-status": dataStatus, className: (0, classnames_1.default)('fui-AvatarRoot', className, `fui-r-size-${size}`, { 'fui-high-contrast': highContrast }, `fui-shape-${shape}`), style: style },
