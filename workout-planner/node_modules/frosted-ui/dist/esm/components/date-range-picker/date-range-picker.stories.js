...
import { Button, DateField, DateRangePicker, Inset, Popover, RangeCalendar, Separator, dateRangePickerPropDefs, } from '..';
...
export const Default = {
    ...
    render: (args) => (React.createElement("div", { style: { display: 'flex', flexDirection: 'column', gap: 'var(--space-5)' } },
        React.createElement(DateRangePicker, { ...args }))),
};
export const Sizes = {
    args: {},
    render: (args) => (React.createElement("div", { style: { display: 'flex', flexDirection: 'column', gap: 'var(--space-5)' } },
        React.createElement(DateRangePicker, { ...args, size: "1" }),
        React.createElement(DateRangePicker, { ...args, size: "2" }),
        React.createElement(DateRangePicker, { ...args, size: "3" }),
        React.createElement(DateRangePicker, { ...args, size: "4" }))),
};
export const Custom = {
    args: {},
    render: () => {
        const [date, setDate] = React.useState(null);
        const [calendarDate, setCalendarDate] = React.useState(date || { start: null, end: null });
        const [focusedDate, setFocusedDate] = React.useState();
        const formatter = useDateFormatter({ dateStyle: 'medium' });
        return (React.createElement("div", { style: { marginTop: -200 } },
            React.createElement(Popover.Root, { defaultOpen: true, onOpenChange: (open) => {
                    if (!open) {
                ...
                React.createElement(Popover.Trigger, null,
                    React.createElement(Button, { size: "3" },
                        ...
                        date
                            ...
                            : '--')),
                React.createElement(Popover.Content, { variant: "translucent", align: "center", style: { minWidth: 'unset' } },
                    React.createElement("div", { style: { display: 'flex', flexDirection: 'column', justifyContent: 'center' } },
                        React.createElement("div", { style: {
                            ...
                            React.createElement(DateField, { "aria-label": "Start date", value: calendarDate.start, onChange: (date) => {
                            ...
                            React.createElement(DateField, { "aria-label": "End date", value: calendarDate.end, onChange: (date) => {
                                    setCalendarDate((state) => ({
                                        ...state,
                                        end: date || null,
                                    }));
                        ...
                        React.createElement(RangeCalendar, { value: calendarDate.start && calendarDate.end ? { start: calendarDate.start, end: calendarDate.end } : null, onChange: (value) => {
                                if (value === null) {
                        ...
                        React.createElement("div", { style: { marginTop: 'var(--space-4)' } },
                            React.createElement(Inset, { side: "x" },
                                React.createElement(Separator, { size: "4" }))),
                        React.createElement("div", { style: {
                                display: 'flex',
                            ...
                            React.createElement(Popover.Close, null,
                                React.createElement(Button, { style: { flex: 1 } }, "Cancel")),
                            React.createElement(Popover.Close, null,
                                React.createElement(Button, { variant: "classic", style: { flex: 1 }, disabled: !calendarDate.start || !calendarDate.end, onClick: () => {
...
const ArrowRightIcon = () => (React.createElement("svg", { width: "12", height: "12", viewBox: "0 0 12 12", fill: "none", xmlns: "http://www.w3.org/2000/svg" },
    React.createElement("path", { d: "M0.75 6H11.25M11.25 6L7 1.75M11.25 6L7 10.25", stroke: "var(--gray-a10)", strokeWidth: "1.5", strokeLinecap: "round", strokeLinejoin: "round" })));
