...
const Avatar = (props) => {
    const { className, style, size = avatarPropDefs.size.default, color = avatarPropDefs.color.default, highContrast = avatarPropDefs.highContrast.default, fallback: fallbackProp, shape = avatarPropDefs.shape.default, ...imageProps } = props;
    ...
    return (React.createElement(AvatarPrimitive.Root, { "data-accent-color": color, "data-status": dataStatus, className: classNames('fui-AvatarRoot', className, `fui-r-size-${size}`, { 'fui-high-contrast': highContrast }, `fui-shape-${shape}`), style: style },
