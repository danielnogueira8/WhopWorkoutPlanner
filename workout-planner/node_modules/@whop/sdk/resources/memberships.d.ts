...
export declare class Memberships extends APIResource {
     ...
     * - `member:basic:read`
     */
    list(query: MembershipListParams, options?: RequestOptions): PagePromise<MembershipListResponsesCursorPage, MembershipListResponse>;
    /**
...
export interface MembershipListParams extends CursorPageParams {
     ...
     */
    cancel_options?: Array<'too_expensive' | 'switching' | 'missing_features' | 'technical_issues' | 'bad_experience' | 'other' | 'testing'> | null;
    /**
