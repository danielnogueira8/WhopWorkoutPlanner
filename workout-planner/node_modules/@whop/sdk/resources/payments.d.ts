...
export declare class Payments extends APIResource {
     ...
     * ```
     */
    list(query: PaymentListParams, options?: RequestOptions): PagePromise<PaymentListResponsesCursorPage, PaymentListResponse>;
    /**
     * Refunds a payment
     *
     * Required permissions:
...
export interface PaymentListParams extends CursorPageParams {
     ...
     */
    billing_reasons?: Array<'subscription_create' | 'subscription_cycle' | 'subscription_update' | 'one_time' | 'manual' | 'subscription'> | null;
    /**
